...
public class JMDBC {
   ...
   public static void insert(MongoCollection<Document> collection) {
	   ...
	   String[] p28= {"스트레스","우울","간","신장","햄스트링","종아리","엉덩이","둔부","무릎","허벅지","소화","폐경","불면증","두통"};
	   ...
	   String[] p45= {"어깨", "척추", "베", "허리"};
	   String[] p46= {"엉덩이", "사타구니", "어깨", "가슴", "배", "폐", "심장"};
	   String[] p47= {"햄스트링","다리"};
	   String[] p48= {"복부","어깨","팔","허벅지","엉덩이","등","발목","무릎",",복부 기관","신장","폐","갈비뼈"};
	   String[] p49= {"다리","무릎","발목","사타구니","척추","허리","가슴","폐","어깨","복부 기관","체력","요통","임신중기","손목 터널 증후군","평발","불임","골다공증","좌골신경동"};
	   ...
	   String[] p56= {"등" , "어깨" , "가슴"};
	   String[] p57= {"뇌" , "스트레스" , "우울증" , "간" , "신장" ,"헴스트링" , "종아리" , "엉덩이" , "허벅지" , "무릎" , "소화" , "폐경" , "피로" , "불안" , "두통" , "불면증"};

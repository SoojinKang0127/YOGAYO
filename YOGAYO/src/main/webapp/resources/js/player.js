document.addEventListener("DOMContentLoaded", function () {
  ...
  function sendAjaxRequest(index) {
    ...
    $.post("https://posedetect.shop/index", json, function (data) {
      console.log(data);
      mp3_path=data
    });
  }
  ...
  $('body').append('<div class="domain" style="height: 600px; width: 1310px; background-color: #2d8cff; display:inline-block;z-index=5;position:absolute;margin-top=20px;margin-left:90px;opacity:0.9"><div>의자 자세/ 삼각 자세/ 플랭크 자세에서 포즈 디텍팅을 진행합니다.</div><div><a>화면 중앙에 전신이 나오도록 위치해주세요.</a></div><div class="ok">확인</div></div>')

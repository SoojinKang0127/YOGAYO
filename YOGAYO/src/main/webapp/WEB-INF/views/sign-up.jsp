	...
	<section id="step_1">
		...
		<div class="sign-up-form">
			<form action="sign-up" method="POST">
				...
				<input type="hidden" name="interest_2" id="interest_2" value="false">
				<input type="hidden" name="interest_3" id="interest_3" value="false">
				<input type="hidden" name="interest_4" id="interest_4" value="false">
				<input type="hidden" name="interest_5" id="interest_5" value="false">
				<input type="hidden" name="interest_6" id="interest_6" value="false">
				<input type="hidden" name="interest_7" id="interest_7" value="false">
				<input type="hidden" name="interest_8" id="interest_8" value="false">
				<input type="hidden" name="interest_9" id="interest_9" value="false">
				<input type="hidden" name="interest_10" id="interest_10"
					value="false"> <input type="hidden" name="interest_11"
					id="interest_11" value="false"> <input type="hidden"
					name="interest_12" id="interest_12" value="false"> <input
					type="hidden" name="interest_13" id="interest_13" value="false">
				<input type="hidden" name="interest_14" id="interest_14"
					value="false"> <input type="hidden" name="interest_15"
					id="interest_15" value="false"> <input type="hidden"
					name="interest_16" id="interest_16" value="false"> <input
					type="hidden" name="interest_17" id="interest_17" value="false">
				<input type="hidden" name="interest_18" id="interest_18"
					value="false"> <input type="hidden" name="interest_19"
					id="interest_19" value="false"> <input type="hidden"
					name="interest_20" id="interest_20" value="false"> <input

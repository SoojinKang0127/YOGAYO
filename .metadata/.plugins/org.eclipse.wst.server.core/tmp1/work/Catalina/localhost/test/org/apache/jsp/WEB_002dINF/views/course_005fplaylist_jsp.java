 ...
 * Generated at: 2020-09-10 06:58:46 UTC
...
public final class course_005fplaylist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"title\" class=\"textbox1\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"코스의 제목을 입력하세요\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"course_explain\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"dscrt\" class=\"textbox2\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"searching_box\" class=\"textbox3\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"원하는 포즈명을 검색해보세요\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"keyword_box\" name=\"keywordBox\" placeholder=\"키우드를 입력하세\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");

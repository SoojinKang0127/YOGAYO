 ...
 * Generated at: 2020-09-13 07:30:04 UTC
...
public final class course_005fplaylist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"searching_box\" class=\"search_box\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"원하는 포즈명을 검색해보세요\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"course_keyword\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"keyword_box\" name=\"keywordBox\" placeholder=\"키우드를 입력하세\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
